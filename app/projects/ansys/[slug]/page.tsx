...
export default function AnsysProjectDetailPage({ params }: { params: Promise<{ slug: string }> | { slug: string } }) {
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <p style={{
                                ...
                                This ANSYS simulation demonstrates comprehensive computational analysis capabilities using advanced meshing techniques
                                and boundary conditions. The study evaluates critical parameters under realistic operating conditions, providing
                                valuable insights for design optimization and validation. Results showcase professional-grade engineering analysis
                                with detailed post-processing and verification.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                {[
                                    ...
                                    'Analysis Type: Multi-physics',
                                    'Mesh Elements: 500K+ nodes',
