...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#d8d8d8] text-[#1f2937] selection:bg-stone-400 selection:text-stone-900 overflow-x-hidden pt-20 sm:pt-6 p-3 sm:p-6 md:pl-28 lg:pl-32 space-y-5">
      <PortfolioNavbar />
      <PortfolioHero />
      <PortfolioAbout />
      <PortfolioExperience />
