...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Designed and built an <strong class=\"text-slate-900 font-bold\">ATmega328-based irrigation system</strong> that uses <strong class=\"text-slate-900 font-bold\">soil moisture sensors</strong> to monitor real-time soil conditions and <strong class=\"text-slate-900 font-bold\">automatically activates a water pump</strong> to deliver the right amount of water to plants, <strong class=\"text-slate-900 font-bold\">optimizing water usage</strong> and reducing manual intervention.",
    links: [
  ...
  },
  {
    ...
    description: "Designed a scaled cantilever storm surge gate using balsa wood, applying <strong class=\"text-slate-900 font-bold\">Mechanics of Materials principles</strong> to optimize structural performance under a <strong class=\"text-slate-900 font-bold\">50 N horizontal surge load</strong>. Designs were analytically evaluated using <strong class=\"text-slate-900 font-bold\">Mathcad and SolidWorks</strong>; the final <strong class=\"text-slate-900 font-bold\">Quad Arm Lattice structure</strong> not only met the design criteria but handled a <strong class=\"text-slate-900 font-bold\">maximum load of 2,121 N</strong>.",
    links: [
      { label: "Side View", url: "" },
      { label: "Top View", url: "" }
    ]
  },
  {
    ...
    date: null,
    association: "Academic Project",
    description: "Developed a <strong class=\"text-slate-900 font-bold\">car inventory and recommendation system</strong> that accepts user requirements and processes them against a <strong class=\"text-slate-900 font-bold\">comprehensive vehicle database</strong> to select <strong class=\"text-slate-900 font-bold\">tailored car recommendations</strong>. The system streamlined the vehicle selection process by filtering and matching user preferences such as <strong class=\"text-slate-900 font-bold\">color, brand, torque specs, and features</strong> to the most suitable available options.",
    links: [
  ...
  },
  {
    ...
    description: "Designed and implemented a self-balancing robot using <strong class=\"text-slate-900 font-bold\">PID control logic</strong> to maintain an upright position on two wheels. An <strong class=\"text-slate-900 font-bold\">MPU-6050 gyroscope and accelerometer</strong> module processed <strong class=\"text-slate-900 font-bold\">6-axis motion data</strong> to deliver real-time orientation feedback, while an <strong class=\"text-slate-900 font-bold\">L298N H-Bridge motor driver</strong> transmitted control signals to regulate two DC motors for <strong class=\"text-slate-900 font-bold\">autonomous balancing</strong>.",
    links: [
