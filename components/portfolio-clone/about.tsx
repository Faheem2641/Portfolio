        ...
        <div className="neu-raised rounded-[40px] p-6 sm:p-10 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start pt-2">
            ...
            <div className="lg:col-span-7 space-y-2.5 text-left">
              ...
              <p className="text-slate-700 leading-snug text-sm font-normal">
              ...
              <p className="text-slate-700 leading-snug text-sm font-normal">
                My work spans <strong className="text-slate-900 font-bold">precision manufacturing</strong>, <strong className="text-slate-900 font-bold">thermal systems (Heat Exchangers)</strong>, and <strong className="text-slate-900 font-bold">embedded control (ATmega328 and Tensilica LX-6)</strong>. Alongside this, I bring hands-on experience in CAD modeling, digital manufacturing, rapid prototyping, PCB design, and applied engineering research.
              </p>
