      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex justify-center mb-12">
          <div className="flex items-center gap-3 border-2 border-white/20 rounded-full px-6 py-3">
            ...
            <span className="text-sm font-bold uppercase tracking-wider">TEAM FAHEEM ALI SINCE 2020</span>
          </div>
        </div>
        */}
        ...
        <div className="text-center">
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight text-balance leading-[1.1] xl:text-8xl">
            ...
            <br />
            the <span className="text-lorenzo-accent font-brier leading-[1.1]">better</span>."
            <br />
            <span className="text-2xl md:text-3xl lg:text-4xl font-normal normal-case tracking-normal mt-4 block opacity-80">
              — Christian Huygens
            </span>
          </h2>
        </div>
