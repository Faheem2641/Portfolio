...
export default function RiderTechSection() {
  ...
  return (
    <section id="tech-specs" className="relative min-h-screen bg-white px-6 md:px-12 overflow-visible py-0 mb-0 pb-24 -mt-[500px] z-20">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-base mt-6 max-w-2xl text-lorenzo-dark md:text-base">
            Explore the technical specifications of Faheem Ali's professional equipment. Hover over the points to discover
            more.
          </p>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="relative w-full aspect-[4/3] md:aspect-[3/2]">
            <Image src="/images/lorenzo-pose33.jpg" alt="Faheem Ali Tech Specs" fill className="object-contain" priority />
