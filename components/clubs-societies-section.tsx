...
const clubExperiences: ClubExperience[] = [
    {
        id: "hack-club",
...
export default function ClubsSocietiesSection() {
    const [activeTab, setActiveTab] = useState(clubExperiences[0].id)
        ...
        <section className="relative min-h-screen bg-lorenzo-dark text-lorenzo-text-light py-12 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    >
                        Clubs &{" "}
                        <span className="text-lorenzo-accent font-brier">Societies</span>
                    </motion.h1>
                    ...
                    >
                        Building connections, developing skills, and creating impact through active participation
                    </motion.p>
                </div>
                                ...
                                <div className="space-y-6 mb-20">
                                    ...
                                    <div className="flex flex-wrap items-center gap-3">
                                        ...
                                        <div className="flex items-center gap-2 bg-lorenzo-accent/20 px-4 py-2 rounded-full border-2 border-lorenzo-accent/50">
                                            ...
                                            <span className="text-sm font-bold text-lorenzo-accent whitespace-nowrap">{activeExperience.category}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-8">
                                        <h4 className="text-xl md:text-2xl font-bold uppercase mb-4 text-lorenzo-accent">
                                            Key Activities
                                        </h4>
                                        <ul className="space-y-3">
                                            {activeExperience.achievements.map((achievement, index) => (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-base md:text-lg opacity-90">{achievement}</span>
                                                </motion.li>
                                            ))}
                                        </ul>
                                    </div>
