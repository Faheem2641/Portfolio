      ...
      <div className="grid md:grid-cols-2 min-h-screen">
        ...
        >
          <motion.div whileHover={{ scale: 1.1 }} transition={{ duration: 0.7 }} className="absolute inset-0">
            <Image src="/images/CAPACETE_FAHEEM_ALI_OFICIAL.png" alt="On Track" fill className="object-cover" />
          </motion.div>
        ...
        >
          <motion.div whileHover={{ scale: 1.1 }} transition={{ duration: 0.7 }} className="absolute inset-0">
            <Image src="/images/faheem-ali-off.png" alt="Off Track" fill className="object-cover" />
          </motion.div>
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-10" />
